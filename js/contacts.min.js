(() => {
  ...
  class l {
    constructor({
      ...
      if (
        ...
        if (!r(this.options, l.instance.options))
          throw new Error(
  ...
  const o = function () {
    var e = new l({
        apiKey: "AIzaSyCshaYz0RbtMAATYOZqMGiX7LGc-gEu0Cg",
        version: "weekly",
      }),
    ...
    e.load().then(function () {
      ...
      new google.maps.Marker({ position: i, map: e, icon: "./svg/pin.svg" });
    });
  };
